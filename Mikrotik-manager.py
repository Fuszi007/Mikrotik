...
window.geometry("800x480+500+300")
...
#def chooseFile():
    #window.sourceFile = filedialog.askopenfilename(parent=window, initialdir= "/home/$USER", title='Please select a directory')
...
button9 = ttk.Button(window, text='Here', width=4, command=backupScript)
...
l6 = ttk.Label(window, text='Enter your script to upload or import backup script')
...
button7.place(x=510, y=450)
button8.place(x=590, y=20)
button9.place(x=355, y=325)
output.place(x=400, y = 58)
